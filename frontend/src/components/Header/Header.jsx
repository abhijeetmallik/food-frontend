...
const images = [assets.header_img1, assets.header_img2, assets.header_img3, assets.header_img4, assets.header_img5, assets.header_img6, assets.header_img7, assets.header_img8]; // Add all image paths here
